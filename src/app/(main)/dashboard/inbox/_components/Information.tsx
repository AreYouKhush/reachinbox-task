  ...
  return (
    <div className="pt-4">
      <div className="px-2 flex flex-col gap-5">
        <div className="bg-zinc-800 p-2 px-3 rounded-lg font-bold">
          Lead Details
        </div>
        <div className="flex justify-between text-sm">
          <div>Name</div>
          <div className="text-zinc-300">{email?.fromName}</div>
        </div>
        <div className="flex justify-between text-sm">
          <div>Contact No</div>
          <div className="text-zinc-300">+54-9062827869</div>
        </div>
        <div className="flex justify-between text-sm">
          <div>Email Id</div>
          <div className="text-zinc-300">{email?.fromEmail}</div>
        </div>
        <div className="flex justify-between text-sm">
          <div>LinekedI</div>
        ...
        <div className="flex justify-between text-sm">
          <div>Compant</div>
          <div className="text-zinc-300">Reachinbox</div>
        </div>
      </div>
